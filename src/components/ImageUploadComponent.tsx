...
export default function ImageUploadComponent({ handleFileSelect }: { handleFileSelect: (e: any) => void }) {
      ...
      <Box position="relative" height="100%" width="100%" flex="1">
        {selectedFile ? (
          <Box height="100%" width="100%" top="0" left="0">
            <img src={URL.createObjectURL(selectedFile)} height="100%" width="100%" alt="Preview" />
          </Box>
        ) : (
